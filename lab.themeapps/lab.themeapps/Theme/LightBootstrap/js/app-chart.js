...
$(document).ready(function () {
    ...
    function RebindChart() {
        $("#canvasChart").remove();
        $("#divChartContainer").append('<canvas style="background-color:##fff;padding-top:50px" id="canvasChart"></canvas>')
    }
    ...
    function PopulateChart(chartData) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: GetPopulatedDataSet(chartData.Series),
    ...
    function PrintCanvas() {
        var dataUrl = document.getElementById('canvasChart');
        console.log(dataUrl);
        ...
        windowContent += '<footer style="float:right;margin-top:100px"><div><img height=30;width=50 src="../Content/img/logo.png"></div></footer>';
        windowContent += '</body>';
        windowContent += '</html>';
